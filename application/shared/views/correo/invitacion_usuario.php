				...
				<td valign="top"><table width="600" height="204" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					<td style="height: 63px;"><table width="100%" border="0" cellspacing="0" cellpadding="10">
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; font-size: 11px; color: #808080; padding-top: 15px;"><?= $CI->lang->line('correo_invius_placeholder') ?></td>
					  </tr>
					</table></td>
				...
				<td valign="top" bgcolor="#161616"><table width="100%" border="0" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						<td><img src="<?php echo base_url('img/correo/inviusuario.jpg') ?>" width="600" height="269" alt="" style='border-radius:5px;' ></td>
					  </tr>
					  <tr>
						<td style="height: 30px;">&nbsp;</td>
					  </tr>
					  ...
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #767572; letter-spacing: -2px;"><?= $CI->lang->line('correo_invius_hi') ?></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; color: #767572;">
							<p><?= $CI->lang->line('correo_invius_desc') ?></p>
							<p>
								<b><?= $CI->lang->line('correo_invius_link') ?> </b> <?= $Invitacion ?>
							</p>
						</td>
					  </tr>
					  <tr>
