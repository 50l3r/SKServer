...
<html>
	<head>
		<title><?php echo  $this->config->item('marca') ?></title>
				...
				<td valign="top"><table width="600" height="204" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					<td style="height: 63px;"><table width="100%" border="0" cellspacing="0" cellpadding="10">
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; font-size: 11px; color: #808080; padding-top: 15px;"><?= $CI->lang->line('correo_altaus_placeholder') ?></td>
					  </tr>
					</table></td>
				  ...
				  <tr>
					<td valign="top" style="width: 504px; height: 125px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="height: 125px;">
					  ...
					  <tr>
						<td valign="top" bgcolor="#161616" style="height: 50px; font-family: Helvetica, Arial, sans-serif; font-size: 55px; font-weight: bold; color: #f9f8f2; letter-spacing: -2px; line-height: 90%;"> <?php echo  $this->config->item('marca') ?> </td>
					  </tr>
					  <tr>
				...
				<td valign="top" bgcolor="#161616"><table width="100%" border="0" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
					<td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						<td><img src="<?php echo base_url('img/correo/altaUsuario.jpg') ?>" width="600" height="269" alt="" style='border-radius:5px;' ></td>
					  </tr>
					  <tr>
						<td style="height: 30px;">&nbsp;</td>
					  </tr>
					  ...
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; font-size: 30px; font-weight: bold; color: #767572; letter-spacing: -2px;"><?= $CI->lang->line('correo_altaus_hi') ?> <?php echo strip_tags($UsuarioNick); ?></td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td style="font-family: Helvetica, Arial, sans-serif; color: #767572;">
							<p><?= $CI->lang->line('correo_altaus_desc') ?></p>
							<p>
								<b><?= $CI->lang->line('correo_altaus_user') ?> </b> <?= $UsuarioNick ?>
								<br />
								<b><?= $CI->lang->line('correo_altaus_key') ?> </b> <?= $UsuarioClave ?>
							</p>
						</td>
					  </tr>
					  <tr>
